        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="#" class="site_title"><i class="fa fa-paw"></i> <span>E-Permit TCH</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <!-- Side Menu Yang belum ditampilkan  -->
                  <li><a><i class="fa fa-edit"></i>Progress Izin <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Izin Sakit</a></li>
                      <li><a href="#">Izin Khusus</a></li>
                      <li><a href="#">Izin Tengah Kerja</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i>Progress Cuti <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-table"></i>Progress Lembur <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <!-- End Side menu yang belum ditampilkan  -->
                </ul>
              </div>
              <div class="menu_section">
                <h3>Laporan</h3>
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i>Masih mikir<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Title Konten bisa dirubah</h3>
              </div>
